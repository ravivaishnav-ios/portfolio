...
const TechnicalSkill = () => (
  <section style={{ padding: '20px' }}>
    ...
    <p>
        <strong>Languages:</strong> Objective-C, Swift, SwiftUI , JavaScript / Typescript React Native, React.js, Redux, ES6, HTML, DART (Flutter), Kotlin, Java, Django and Python.<br />
        <strong>Frameworks/Libraries:</strong> React, React Native, Node.js, Express<br />
        <strong>Databases:</strong>MySQL, GraphQL API, MongoDB, RealM, Realtime database, iOS Core Database, SQLite Development, Firebase Database<br />
